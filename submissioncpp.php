<?php
    ...
    if(!(isset($_POST["name"])&&isset($_POST["phone"])&&isset($_POST["semester"])&&isset($_POST["branch"])&&isset($_POST["program1"])&&isset($_POST["program2"])&&isset($_POST["program3"]))){
        ...
        try{
            ...
            $file = fopen("submissions/".$_POST["name"]."_".$_POST["phone"]."_".$_POST["semester"]."_".$_POST["branch"]."_".date("h:i:sa")."/program1.cpp","w");
            fwrite($file,$_POST["program1"]);
            fclose($file);

            $file = fopen("submissions/".$_POST["name"]."_".$_POST["phone"]."_".$_POST["semester"]."_".$_POST["branch"]."_".date("h:i:sa")."/program2.cpp","w");
            fwrite($file,$_POST["program2"]);
            fclose($file);

            $file = fopen("submissions/".$_POST["name"]."_".$_POST["phone"]."_".$_POST["semester"]."_".$_POST["branch"]."_".date("h:i:sa")."/program3.cpp","w");
            fwrite($file,$_POST["program3"]);
            fclose($file);

            $file = fopen("submissions/".$_POST["name"]."_".$_POST["phone"]."_".$_POST["semester"]."_".$_POST["branch"]."_".date("h:i:sa")."/program4.cpp","w");
