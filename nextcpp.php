...
<body>
    <div class="container">
        ...
        <form action="submissioncpp.php" id="form" method="POST">
    ...
    do{
        ...
        default;
            ...
            <div class="form-group" id="prog3">
                ...
                cin.getline(string-variable, 100, '\n'); is use to read string with whitespaces. <br>
                </label>
